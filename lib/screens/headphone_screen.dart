import 'package:commerce_mobile_app/widgets/sale.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Sale(path: "assets/products/headphone.png", name: "Headphone", description: "Boat Air dopes 121V2", color: "grey")
        ),
      ),
    );
  }
